...
const user1 = {
  ...
  pincode: "000000",
  about:
    "An abstract persona used for testing purposes. Does not belong to any country or real entity.",
};
        ...
        {loading ? (
          ...
          <Box>
            ...
            <Box sx={{ p: { xs: 3, md: 5 }, position: "relative" }}>
              <Avatar
                src={
                  userProfile?.fetchedUsed?.profilePhoto ||
                  "https://lh3.googleusercontent.com/aida-public/AB6AXuBJbeYJKaFNeGPnhYHTwz0JPZjUTmEk08oJPoGNZmNKvK0D5jZL-Uv6KuyqwUiWoguYrRUYyySVtnnirl7-nFpOHFvuzBUIEq9QCN4gsnzwr53pMWe7pWzG6OjMW2RxKyotKtj7nShvTPF0cYVeSx5-hwiDucPvvS2fBhhwiI1k7a-f_Sh5c6652WhX6ZsWBk2WATdlU_EtVMXpNRLKb7eo1UVZsoovtJ9WU5kP8ptMFqRTltvj0mqhi-P3yRDmM1MaNAPUOPqnvXE"
                }
              ...
              <Box sx={{ mt: 2 }}>
                <Typography
                  variant="h4"
                  sx={{ color: theme.palette.textColor, fontWeight: "bold" }}
                >
                ...
                <Typography
                  variant="subtitle1"
                  sx={{ color: theme.palette.subtextColor, mt: 0.5 }}
                >
              ...
              <Box sx={{ mt: 4 }}>
                ...
                <Typography
                  sx={{ color: theme.palette.subtextColor, lineHeight: 1.6 }}
                >
                ...
                <Grid container spacing={{ xs: 2, md: 3 }}>
                  ...
                  <Grid item xs={12} md={6} lg={8}>
                    <InfoItem
                      ...
                      label="Social Links"
                      value={
                        userProfile?.fetchedUsed?.socialLinks ||
                        user1.socialLinks
                      }
                    />
                  </Grid>
